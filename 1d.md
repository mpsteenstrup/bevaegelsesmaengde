...
Newton definerede kraften som den tidsafledte af bevægelsesmængden i sin 2. lov ved, $\( \vec{F} =\frac{d \vec{p}}{dt} = \frac{d m\vec{v}}{dt} = m\cdot \vec{a} \)$, hvor jeg har brugt, at den tidsafledte af hastigheden jo er accelerationen. 
